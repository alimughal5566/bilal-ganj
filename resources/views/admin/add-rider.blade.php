            ...
            <div class="row justify-content-center">
                ...
                <div class="">
                    <div class="account_form register">
                        ...
                        @endif
                        <form action="{{route('saveRider')}}" method="post" class="needs-validation shadow p-5"
                              novalidate>
                            @csrf
                            <h2 class="d-flex justify-content-center">Add Rider <i class="fa fa-motorcycle pt-1 pl-2"></i></h2>
                            <small class="text-danger">*All Fields are Required</small>
                            @include('admin.includes.rider-form')
                            <div class="form-row pt-3">
                                <div class="login_submit save_rider">
                                    <button type="submit" class="btn btn-block btn-success">Add Rider</button>
                                </div>
                            </div>
                        </form>
                    </div>
