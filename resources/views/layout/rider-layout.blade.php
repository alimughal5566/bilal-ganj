                                ...
                                @if(Auth::check())
                                                ...
                                                <div class="dropdown-menu-right"
                                                    ...
                                                    @foreach($notifications as $notification)
                                                        <a class="{{$notification->status===0?'fa fa-envelope-o ':'fa fa-envelope-open-o'}} dropdown-item"
                                                           href="{{route('riderNotification',['notification'=>$notification])}}">
                                    ...
                                    <li class="top_links"><a href="#"><i class="ion-android-person"></i> My Account<i
                                        ...
                                        <ul class="dropdown_links">
                                            <li><a href="{{route('riderPanel')}}">My Account </a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="breadcrumb_content py-3">
                                                    <ul class="pl-0">
                                                        <li><a href="{{route('riderPanel')}}">home</a></li>
                                                        <li>@yield('content')</li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <div class="dashboard_tab_button">
                        <ul role="tablist" class="nav flex-column dashboard-list" id="myTab">
                            <li><a href="{{route('riderPanel')}}" class="nav-link">Account Details</a></li>
                            <li><a href="{{route('scheduleRides')}}" class="nav-link">Schedule Rides </a></li>
                            <li><a href="{{route('rideHistory')}}" class="nav-link">History</a></li>
...
<!--footer area end-->
<script>
    let SAVETIME = "{{route('saveStartTime')}}";
</script>
