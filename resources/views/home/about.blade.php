            ...
            <div class="row align-items-center">
                <div class="col-12">
                    ...
                    <div class="about_content">
                        <h1>Welcome to Bilal Ganj Application!</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{asset('assets/frontend/img/about/About_icon1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{asset('assets/frontend/img/about/About_icon2.jpg')}}" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{asset('assets/frontend/img/about/About_icon3.jpg')}}" alt="">
                        </div>
                        <div class="chose_content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_gallery_section">
                        <div class="gallery_thumb">
                            <img src="{{asset('assets/frontend/img/service/services2.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_gallery_section">
                        <div class="gallery_thumb">
                            <img src="{{asset('assets/frontend/img/service/services1.jpg')}}" alt="">
                        </div>
                        <div class="about_gallery_content">
                            <h3>Our Mission</h3>
                            <p>Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_gallery_section">
                        <div class="gallery_thumb">
                            <img src="{{asset('assets/frontend/img/service/services3.jpg')}}" alt="">
                        </div>
                        <div class="about_gallery_content">
                            <h3>History Of Us</h3>
                            <p>Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima.</p>
                ...
                <div class="testimonial_active owl-carousel">
                    <div class="col-12">
                        <div class="single_testimonial">
                            ...
                            <img src="{{asset('assets/frontend/img/about/testimonial4.jpg')}}" alt="">
                    ...
                    <div class="col-12">
                        <div class="single_testimonial">
                            <p>These guys have been absolutely outstanding. Perfect Themes and the best of all that you have many options to choose! Best Support team ever! Very fast responding! Thank you very much! I highly recommend this theme and these people!</p>
                            <img src="{{asset('assets/frontend/img/about/testimonial5.jpg')}}" alt="">
                            <span class="name">Kathy Young</span>
                            <span class="job_title">CEO of SunPark</span>
                            <div class="product_ratting">
                                <ul>
                    ...
                    <div class="col-12">
                        <div class="single_testimonial">
                            <p>These guys have been absolutely outstanding. Perfect Themes and the best of all that you have many options to choose! Best Support team ever! Very fast responding! Thank you very much! I highly recommend this theme and these people!</p>
                            <img src="{{asset('assets/frontend/img/about/testimonial6.png')}}" alt="">
                            <span class="name">Kathy Young</span>
                            <span class="job_title">CEO of SunPark</span>
                            <div class="product_ratting">
                                <ul>
