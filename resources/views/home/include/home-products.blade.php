...
<section class="product_area mb-50">
    <div class="container {{isset($flag)?'px-0':''}}">
        <div class="row">
            <div class="col-12">
                <div class="section_title {{isset($flag)?'my_section':''}}">
                    @if($allProducts->first()!=null)
                        <h2><span> <strong>{{isset($flag)?'Related':'Our'}}</strong>Products</span></h2>
                    @endif
                </div>
        ...
        <div class="tab-content {{isset($flag)?'home_products_section':''}}">
                    ...
                    @foreach($allProducts as $product)
                        ...
                        <div class="single_product">
                            <div class="product_name">
                                <h3><a href="{{route('productDetail',['id'=>$product->id])}}">{{$product->name}}</a>
                                </h3>
                            </div>
                            <div class="product_thumb">
                                ...
                                <div class="action_links">
                                    <ul>
                                        ...
                                        <input type="hidden" name="image_size" value="{{count($images)}}">
                                        <li class="quick_button"><a href="#" data-toggle="modal"
                                                                    data-target="#modal_box"
                                                                    title="quick view">

                                                <span class="lnr lnr-magnifier custom_magnifier"></span></a></li>
                                        <li class="wishlist">
                                    ...
                                    <div class="product_footer d-flex align-items-center">
                                        ...
                                        <div class="add_to_cart">
                                            <form>
                                                ...
                                                <a title="add to cart">
                                                            <span
                                                                    class="{{Auth::check()?'cart_btn custom_cart':" bg-transparent border-0 goto_cart"}} lnr lnr-cart"
                                    ...
                                    <div class="modal_add_to_cart">
                                        <form class="modal_cart" action="#">
                                            ...
                                            <input min="0" max="" value="1"
                                                   name="get_quantity" class="get_quantity" type="number">
