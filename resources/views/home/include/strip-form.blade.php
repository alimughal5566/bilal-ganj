                        ...
                        <div class="panel panel-default credit-card-box">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="{{ route('stripePost') }}" method="post"
                                    ...
                                    <div class='form-row row'>
                                        <div class='col form-group required'>
                                            <label class='control-label'>Name on Card</label> <input
                                                    class='form-control' value="{{old('cardName')}}" name="cardName"
                                    ...
                                    <div class='form-row row'>
                                        <div class='col form-group card required p-2'>
                                            <label class='control-label'>Card Number</label> <input
                                                    autocomplete='off' name="cardNumber"
                                                    class='form-control card-number'
                                                    maxlength="16"
                                                    type='text' value="{{old('cardNumber')}}"
                                    ...
                                    <div class='form-row row'>
                                        ...
                                        <div class='col-xs-12 col-md-4 form-group expiration required'>
                                            <label class='control-label'>Expiration Month</label> <input
                                                    ...
                                                    maxlength="2"
                                                    type='text' value="{{old('expMonth')}}"
                                                    onkeypress="return /[0-9]/i.test(event.key)" name="expMonth"
                                                    required>
                                        ...
                                        <div class='col-xs-12 col-md-4 form-group expiration required'>
                                            <label class='control-label'>Expiration Year</label> <input
                                                    ...
                                                    maxlength="4"
                                                    type='text' value="{{old('expYear')}}"
                                                    onkeypress="return /[0-9]/i.test(event.key)" name="expYear"
                                                    required>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <button class="btn btn-primary btn-lg btn-block stripe_payment"
                                                    type="submit">Pay Now (RS. {{$total}})</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
